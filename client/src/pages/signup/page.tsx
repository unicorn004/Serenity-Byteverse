          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => updateFormData("therapyType", value)}
              >
                <SelectTrigger>
      ...
      case 3:
        return (
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="goals">
                What are your current mental health goals or challenges?
              </Label>
              <Textarea
                id="goals"
              ...
              />
              <p className="text-xs text-muted-foreground">
                This helps us understand your needs better. Your response is
                confidential.
              </p>
            </div>
          </div>
            ...
            <div className="rounded-lg border bg-card p-4">
              ...
              <div className="space-y-1 text-sm">
                ...
                <p>
                  ...
                  {therapyTypes.find((t) => t.value === formData.therapyType)
                    ?.label || "Not specified"}
                </p>
                <p>
