...
export default function Home() {
  ...
  <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground md:text-xl pl-55 pr-55 lg:pl-55 lg:pr-55 md:pl-36 md:pr-36 sm:pl-28 sm:pr-28">
    Personalized support, AI-powered insights, and a community that cares. Take the first step towards a healthier mind today.
      ...
      {/* Features Section */}
      <section className="container py-20 lg:pl-15 lg:pr-15 md:pl-10 md:pr-10 sm:pl-5 sm:pr-5">
      ...
      <section className="bg-primary/5 py-20 lg:pl-15 lg:pr-15 md:pl-10 md:pr-10 sm:pl-5 sm:pr-5">
      ...
      {/* CTA Section */}
      <section className="container py-20 text-center lg:pl-15 lg:pr-15 md:pl-10 md:pr-10 sm:pl-5 sm:pr-5">
